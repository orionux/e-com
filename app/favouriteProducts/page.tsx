                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="product-thumbnail">
                                                <a href="#"><img src="images/productpage/lapsmall.png" alt="" /></a>
                                            </td>
                                        ...
                                        <tr>
                                            <td className="product-remove"><a href="#"><i className="pe-7s-close"></i></a></td>
                                            <td className="product-thumbnail">
                                                <a href="#"><img src="images/productpage/watchsmall.png" alt="" /></a>
                                            </td>
                                        ...
                                        <tr>
                                            <td className="product-remove"><a href="#"><i className="pe-7s-close"></i></a></td>
                                            <td className="product-thumbnail">
                                                <a href="#"><img src="images/productpage/pistol.png" alt="" /></a>
                                            </td>
